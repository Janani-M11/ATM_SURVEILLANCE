...
class LightweightDetectionPipeline:
    ...
    def initialize_models(self):
        """Initialize lightweight detection models"""
        try:
            ...
            print("✅ Lightweight detection models initialized successfully")
    ...
    def detect_helmet(self, frame):
        ...
        try:
            ...
            # Create mask for dark colors (typical helmet colors)
            ...
            for contour in contours:
                ...
                if area > 1000:  # Minimum area threshold
                    # Check if contour is roughly circular/oval (helmet shape)
